...
class ReservationConst
{
    ...
    const STATUS_RELEASED_NAME = 'リリース済';
    ...
    const STATUS_LIST = [
        ...
        self::STATUS_INVITATION => self::STATUS_INVITATION_NAME,

        self::STATUS_UNDER_RELEASE => self::STATUS_UNDER_RELEASE_NAME,
        self::STATUS_RELEASED => self::STATUS_RELEASED_NAME,
        self::STATUS_CANCELING => self::STATUS_CANCELING_NAME,
